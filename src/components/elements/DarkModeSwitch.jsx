...
export default function DarkModeSwitch(){
    ...
    return (
        <label
        htmlFor="themeToggle"
        className="themeToggle st-sunMoonThemeToggleBtn fixed top-5 left-5 z-50 w-7 h-7 flex justify-center items-center rounded-full"
        type="checkbox"
        >
        <input onChange={ToggleDarkMode} type="checkbox" id="themeToggle" className="themeToggleInput" />
        <svg
            width="18"
            height="18"
            viewBox="0 0 20 20"
